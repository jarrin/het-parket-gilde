...
<section class="section cta-section" style="background-image: url('<?php echo h($home['cta']['image']); ?>'); background-color: <?php echo h($home['cta']['colors']['background']); ?>;" data-edit-image="cta.image">
    <div class="container text-center">
        <h2 style="color: <?php echo h($home['cta']['colors']['text']); ?>;" data-edit-path="cta.title"><?php echo h($home['cta']['title']); ?></h2>
        <p style="color: <?php echo h($home['cta']['colors']['text']); ?>;" data-edit-path="cta.subtitle"><?php echo h($home['cta']['subtitle']); ?></p>
