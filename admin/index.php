                        ...
                        <div class="page-title">
                            ...
                            <form method="POST" style="margin-top: 30px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="color" name="cta_bg" value="<?php echo h($content['over_ons']['cta']['colors']['background'] ?? '#222e40'); ?>">
                                </div>
                                
                                <div class="form-group">
                                    <label>Tekstkleur</label>
                                    <input type="color" name="cta_text" value="<?php echo h($content['over_ons']['cta']['colors']['text'] ?? '#ffffff'); ?>">
                                </div>
